...
@section('main-content')
    ...
    <div class="card shadow-none mb-4">
        <div class="card-body wizard-content">
            <h4 class="card-title">Validasi edit siswa baru</h4>
            <p class="card-subtitle mb-3"> Pastikan untuk mengedit data siswa dengan valid </p>
            <form action="{{ route('siswa.update', 1) }}" method="post" class="validation-wizard wizard-circle mt-5">
                @csrf
                @method('PUT')
                <!-- Step 1 -->
                <h6>Step 1</h6>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control required" id="wNIT" name="NIT"
                                    placeholder="Contoh : 22.24.785" value="{{ old('NIT') }}" />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
