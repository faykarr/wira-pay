...
@section('main-content')
    ...
    <div class="card shadow-none position-relative overflow-x-auto mb-4">
        <div class="card-body d-flex align-items-center justify-content-between gap-2 p-4">
            <table class="table table-responsive table-outer-border table-hover rounded-3 overflow-hidden">
