...
@section('main-content')
    <div class="card shadow-none position-relative overflow-hidden mb-2">
        <div class="card-body d-flex flex-wrap align-items-center justify-content-between p-4">
            <h4 class="fw-semibold mb-0">Edit Jurusan Akademik</h4>
    ...
    <div class="card shadow-none mb-4">
        <div class="card-body">
            <h4 class="card-title">Validasi edit jurusan akademik</h4>
            <p class="card-subtitle mb-3"> Pastikan untuk mengedit data jurusan akademik yang valid </p>
